...
export default {
    ...
    data() {
        return {
            jumbos: [
                {
                    text: 'ARE YOU READY FOR YOUR NEXT PERFORMANCE?',
                    img: 'bg2.png'
                }, {
                    text: 'ARE YOU READY FOR YOUR NEXT BEST?',
                    img: 'bg1.png'
                }, {
                    text: 'ARE YOU READY FOR YOUR NEXT CHALLENGE?',
                    img: 'banner1.png'
                }
            ],
